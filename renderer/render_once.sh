...
docker run -e JAVA_TOOL_OPTIONS='-Xmx150g' \
	...
	--languages=ab,ace,af,aht,akz,ale,als,am,an,apj,apm,apw,ar,arp,arz,as,ast,az,az-Arab,az-Cyrl,az-Latn,azb,ba,bar,be,be-tarask,ber,bg,bla,bm,bn,bo,bpy,br,bs,bxr,ca,cdo,ce,ceb,cho,chr,chy,cic,ckb,cku,cmn,co,cow,cr,crh,crh-Cyrl,crk,cro,cs,csb,cv,cy,da,dak,de,dsb,dv,dz,ee,egl,el,en,eo,es,esk,ess,et,eu,fa,fi,fil,fit,fla,fo,fr,frr,fur,fy,ga,gag,gan,gcf,gd,gl,gn,gr,grc,gsw,gu,gv,gwi,ha,haa,hak,hak-Hant,haw,he,hi,hid,hif,hoi,hop,hr,hsb,ht,hu,hup,hur,hy,ia,id,ie,ik,ilo,ing,int,io,is,it,iu,ja,ja-Hira,ja-Latn,jv,ka,kab,kbd,kee,ki,kic,kio,kjq,kk,kk-Arab,kk-Cyrl,kk-Latn,kl,km,kn,ko,ko-Hani,ko-Latn,koy,krc,krl,ks,ku,kuu,kv,kw,ky,kyh,la,lb,lez,li,lij,lld,lmo,ln,lo,lrc,lt,lut,lv,lzh,md,mdf,mez,mg,mhr,mi,mia,mk,ml,mn,mnr,mo,moh,mr,mrj,ms,ms-Arab,mt,mus,mwl,my,myv,mzn,nah,nan,nan-Hant,nan-Latn-pehoeji,nan-Latn-tailo,nds,ne,nez,nl,nn,no,nov,nv,oc,oj,oka,old,one,ood,or,os,ota,otw,pa,pam,pao,pcd,pfl,pl,pms,pnb,pot,pqm,ps,pt,pt-BR,pt-PT,qu,rm,ro,ru,rue,rw,sac,sah,sal,sat,sc,scn,sco,sd,se,see,sgs,sh,shh,si,sju,sk,sl,sma,smj,so,sq,sr,sr-Latn,str,su,sv,sw,syc,szl,ta,tau,tcb,te,tew,tfn,tg,th,th-Latn,ti,tix,tk,tl,tli,tow,tr,tt,tt-Arab,tt-Cyrl,tt-Latn,twf,udm,ug,uk,uma,ur,ute,uz,uz-Arab,uz-Cyrl,uz-Latn,vec,vi,vi-Hani,vls,vo,wa,war,win,wiy,wo,wuu,xmf,yak,yi,yo,ypk,yue,yue-Hans,yue-Hant,yue-Latn,yue-Latn-HK,yue-Latn-jyutping,za,zgh,zh,zh-Bopo,zh-Hans,zh-Hans-CN,zh-Hans-SG,zh-Hant,zh-Hant-CN,zh-Hant-HK,zh-Hant-MO,zh-Hant-TW,zh-Latn,zh-Latn-pinyin,zu,zun,zza
